...
TRL::Microarray::Microarray_File::Clone_Locn_File provides methods for retrieving data from a genomic clone location file. Each row of the file contains a clone name and its genomic location in the format 'Name;bp;chr' (e.g. 'RP11-23C5;7853570;4'. The sex chromosomes can be denoted X and Y or 23 and 24.  
...
TRL::Microarray::Microarray_File
